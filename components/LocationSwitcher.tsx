        ...
        >
          ...
          >
            <span className="flex items-center gap-2">
              <svg className="w-3 h-3 shrink-0 opacity-60" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
          ...
          {locations.map((loc) => {
            const isSelected = viewMode === 'single' && loc.id === selectedBusinessId
            return (
              <button
                key={loc.id}
                type="button"
