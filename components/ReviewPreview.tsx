  ...
  return (
    <div className="w-full max-w-full bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
      ...
      <div className="bg-[#F9F9F9] min-h-[480px] flex flex-col items-center pt-6 pb-16 overflow-y-auto">
        ...
        {screen === 'feedback' && googleReviewUrl && (
          <p className="text-center text-sm text-gray-400 mt-5 px-2">
            Or{' '}
            <button
              type="button"
              className="underline decoration-gray-400 hover:text-gray-600 cursor-pointer p-0 m-0 border-0 bg-transparent text-inherit text-sm font-inherit inline"
              aria-label="leave a Google review (preview only — link disabled)"
            >
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-8 py-12 text-center">
            ...
            {googleReviewUrl && (
              <p className="text-center text-sm text-gray-400 mt-6 pt-5 border-t border-gray-100">
                Prefer to share publicly? You can also{' '}
                <button
                  type="button"
                  className="underline decoration-gray-400 hover:text-gray-600 cursor-pointer p-0 m-0 border-0 bg-transparent text-inherit text-sm font-inherit inline"
                  aria-label="leave a Google review (preview only — link disabled)"
