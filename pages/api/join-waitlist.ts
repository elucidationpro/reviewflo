...
export default async function handler(
  ...
  try {
      ...
      <html>
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="background: linear-gradient(to right, #3b82f6, #2563eb); padding: 40px 30px; border-radius: 10px 10px 0 0; text-align: center;">
            <h1 style="color: #ffffff; margin: 0; font-size: 28px;">Welcome to ReviewFlow!</h1>
          </div>
          ...
          <div style="text-align: center; color: #9ca3af; font-size: 14px; padding: 20px;">
            <p style="margin: 0;">ReviewFlow - Fix it before it goes public</p>
    ...
    const { error: emailError } = await resend.emails.send({
      ...
      to: email,
      subject: 'Welcome to ReviewFlow - You&apos;re on the list!',
      html: emailHtml,
    })
