...
const reviewFloLogo = (
  <svg width="260" height="61" viewBox="0 0 638.77 150" xmlns="http://www.w3.org/2000/svg">
    <path
      ...
      >
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 10, marginBottom: 16 }}>
            {[1, 2, 3, 4, 5].map((n) => (
              <svg key={n} width={52} height={52} viewBox="0 0 24 24" fill="#c9a961">
                <path d={STAR_PATH} />
              </svg>
            ))}
          </div>
        ...
        <p style={{ fontSize: 16, color: '#999999', margin: 0 }}>
          usereviewflo.com
        </p>
      </div>
    ),
